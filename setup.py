...
## Constants
CODE_DIRECTORY = 'interfaz_biometrico_nominai_mi'
DOCS_DIRECTORY = 'docs'
...
#
# However, when we do this, we also import `interfaz_biometrico_nominai_mi/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'interfaz_biometrico_nominai_mi_cli = interfaz_biometrico_nominai_mi.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'interfaz_biometrico_nominai_mi_gui = interfaz_biometrico_nominai_mi.gui:entry_point'
        # ]
    }
)
